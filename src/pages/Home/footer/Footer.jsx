    ...
    return (
        <div>
            <footer className="footer p-10 opacity-90 bg-black text-white">
                <div className='flex gap-5'>
                    ...
                    <div>
                        ...
                        <p className=' font-semibold'>Music Course Agency</p>
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <button className="btn btn-outline absolute top-0 right-0 rounded-l-none">Subscribe</button>
                    </div>
            ...
            <footer className="footer footer-center p-4 bg-black text-white">
                <div>
                    <p>Copyright © 2023 - All right reserved by Music Course Agency</p>
                </div>
            </footer>
        </div>
    );
